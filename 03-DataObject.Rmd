...
Please also read the section \@ref(variableAssignment) and 
\@ref(defineAssignment) on assignment using
...
See section \@ref(VARIABILITY_LEVELS) for discussion of identifying the 
...
### Assignment to a single variable using `variable = <NAME>` {#variableAssignment}
...
### Assignment to multiple variables using `define = < … >` {#defineAssignment}
